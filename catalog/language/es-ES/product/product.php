...
$_['text_login']               = 'Por favor <a href="%s">Inicie Sesión</a> o <a href="%s">Regístrese</a> para comentar';
$_['text_no_reviews']          = 'No hay comentarios para este producto.';
$_['text_note']                = '<span class="text-danger"> Nota:</span> ¡No se permite HTML!';
$_['text_success']             = 'Gracias por su comentario. Ha sido enviado al administrador para su aprobación.';
...
$_['text_trial_description']   = '%s todos los %d  %s(s) para %d pago(s)';
$_['text_payment_description'] = '%s todos los %d %s(s) de %d pago(s)';
...
// Error
$_['error_name']               = '¡Advertencia: Nombre del comentario debe tener entre 3 y 25 caracteres!';
$_['error_text']               = '¡Advertencia: El texto del comentario debe tener entre 25 y 1000 caracteres!';
$_['error_rating']             = '¡Advertencia: Por favor seleccione una calificación en el comentario!';
