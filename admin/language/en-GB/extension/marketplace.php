...
$_['error_api_key']     = 'Warning: Please insert your API Key in order to use Marketplace. If you do not have already an API Key, please goto <a href="http://extensions.interspire.vn/account/login" target="_blank">Interspire Extensions</a>, login and create one.';
