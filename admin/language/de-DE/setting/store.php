...
$_['entry_tax_default']                = 'Verwende Geschäftsadresse zur Steuerberechnung';
...
// Help
$_['help_url']                         = 'URL für diesen Shop, muss mit einem Slash \'/\' abschliessen.<br />Beispiel: http://www.meinedomain.com/path/ oder http://untershop.meinedomain.com/<br /><br />Kein Verzeichniss für neuen Shop verwenden.<br /><b>Es sollte immer entweder auf eine andere Domain oder Subdomain des Hauptshops verwiesen werden</b>';
$_['help_ssl']                         = 'SSL-URL für diesen Shop, muss mit einem Slash \'/\' abschliessen.<br />Beispiel: https://www.meinedomain.com/path/ oder https://untershop.meinedomain.com/<br /><br />Kein Verzeichniss für neuen Shop verwenden.<br /><b>Es sollte immer entweder auf eine andere Domain oder Subdomain des Hauptshops verwiesen werden.</b>.<br />Domains bzw. Subdomains müssen innerhalb des Hauptshops am selben Server liegen, externe Domains sind nicht möglich';
...
$_['help_customer_group']              = 'Standardgruppe welcher neue Kunden zugeordnet werden';
...
$_['error_store']                      = 'Dieser Shop kann nicht gelöscht werden da aktuell %s Auftrag/Aufträge damit verbunden ist/sind.';